...
def worker_2(file_name):
     return make_json_response_2(200, message="File < {} > upload success. Refresh to reload.".format(file_name)), 200

class DateScheduleList(Resource, ScheduleMixin):#post车辆信息
    @as_json_p
