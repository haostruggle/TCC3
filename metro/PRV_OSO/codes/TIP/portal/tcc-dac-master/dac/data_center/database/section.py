...
class SectionTripData(object):#窗口车次数据类
...
class Section(object):
    ...
    def get_trip_count_from_period(self, dt1, dt2):#计算时间内的车次数量
        count = 0
...
class SectionManager(object):
    ...
    def add_record(self, line, trip, stn1, stn2, direction, stn1dep, stn2arr):
        ...
        s1.add_record(trip, stn1, stn2, direction, stn1dep, stn2arr)#_sections_by_direction
...
class SectionIter(object):#会话迭代器
    __TYPE_PLAN__ = "PLAN"
    __TYPE_REAL__ = "REAL"
